<?php
	...
	$result = mysql_query("SELECT COUNT(*) AS COUNTER FROM `A_RESEARCH` WHERE FacultyID = ".$facultyID['FacultyID']." AND ProjectID = ".$projectID.";", $conn) or die(mysql_error());
	...
	if($num_rows_count > 0)
	{
		$interactive_message = "Cannot add this faculty to this project twice!";
		$success = "Failure";
	} else {
